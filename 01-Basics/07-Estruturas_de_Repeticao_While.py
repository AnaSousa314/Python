...
# Aqui criamos um loop infinito que será quebrado manualmente com break. Não é recomendado fazer esse tipo de loop
while True:
    if contador < 10:
        contador = contador + 1 
        if contador == 1:
...
# Aqui usamos o continue para pular uma parte da execeução do código
while contador < 10:
    contador = contador + 1
    if contador == 1:
        continue
