...
b = 2 - 3  # Subtração
c = 2 * 3  # Multiplicação
d = 2 / 3  # Divisão.No python independente se os numeros usados na divisao são ou não float, o resultado da divisão comum sempre sera float
e = 2 // 3 # Divisão inteira, ignora toda parte decimal da divisao, ele não arredonda, só ignora
f = 2 ** 3 # Potência
...
# print(45 // 2.3)#ignora a parte decimal
# print(45/2.3)#inclui a parte decimal
# print(45/2.3)
# print(45+3)
# print(45-3)
# print(45*3)
# print(45**3)#potenciacao
# print(4>3)
# print(4<3)
# print(4>=3)
# print(4<=3)
