...
if float(valor_corrida) <= valor*5:
    print("Pagar a corrida")
if float(valor_corrida) > valor*5:
...
if float(valor_corrida) <= valor*5:
    ...
    if float(valor_corrida) <= valor*6:
        print("Aguarde um momemnto, o valor pode abaixar")
    else:
        print("Pegue o Onibus") """
...
if float(valor_corrida) <= valor*5:
    print("Pagar a corrida")
elif float(valor_corrida) <= valor*6:
    print("Aguarde um momemnto, o valor pode abaixar")
else:
    print("Pegue o Onibus")